...
def listar():
    ...
    if len(produtos) > 0:
        ...
        for produto in produtos:
            print(f'ID: {produtos[0]}.')
            print(f'Produto: {produtos[1]}.')
            print(f'Preço: {produtos[2]}.')
            print(f'Estoque: {produtos[3]}.')
            print('------------------------')
    else:
...
def deletar():
    ...
    if cursor.rowcount == 1:
        print(f'O produto com o id {codigo} foi deletado com sucesso!')
    else:
